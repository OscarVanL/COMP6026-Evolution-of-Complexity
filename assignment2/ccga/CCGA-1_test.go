...
func TestSpecies_Mutate_OneProbability(t *testing.T) {
	input := Species{
		...
		Population{
			Individual{1, 0x0000, 0, 0, 0.0, []uint16{0xFFFF, 0x0000}},
			Individual{1, 0xFFFF, 0, 0, 0.0, []uint16{0x0000, 0xFFFF}},
		},
	}
	input.Mutate(0.0)

	assert.Equal(t, uint16(0x0000), input[0][1].Gene, "Mutation with mutationP=1 should change all bits")
	assert.Equal(t, uint16(0x0000), input[0][1].Coevolution[0], "Mutation with mutationP=1 should change all bits")
	assert.Equal(t, uint16(0xFFFF), input[1][1].Gene, "Mutation with mutationP=1 should change all bits")
	assert.Equal(t, uint16(0x0000), input[1][1].Coevolution[0], "Mutation with mutationP=1 should change all bits")
}
...
func TestSpecies_Mutate_ZeroProbability(t *testing.T) {
	...
	assert.Equal(t, uint16(0x0000), input[0][1].Gene, "Mutation with mutationP=0 should not change any bits")
	assert.Equal(t, uint16(0x0000), input[0][1].Coevolution[0], "Mutation with mutationP=0 should not change any bits")
	assert.Equal(t, uint16(0xFFFF), input[1][1].Gene, "Mutation with mutationP=0 should not change any bits")
	assert.Equal(t, uint16(0x0000), input[1][1].Coevolution[0], "Mutation with mutationP=0 should not change any bits")
}
...
func TestSpecies_Mutate_Elitist(t *testing.T) {
	input := Species{
		...
		Population{
			Individual{1, 0x0000, 0, 0, 0, []uint16{0xFFFF, 0x0000}},
		},
	}

	input.Mutate(1.0)

	assert.Equal(t, uint16(0xFFFF), input[0][0].Gene, "Mutation should follow elitist strategy")
	assert.Equal(t, uint16(0x0000), input[0][0].Coevolution[0], "Mutation should follow elitist strategy")
	assert.Equal(t, uint16(0x0000), input[1][0].Gene, "Mutation should follow elitist strategy")
	assert.Equal(t, uint16(0xFFFF), input[1][0].Coevolution[0], "Mutation should follow elitist strategy")
}
